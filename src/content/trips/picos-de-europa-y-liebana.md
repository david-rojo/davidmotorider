...
itinerary:
  - day: 1
    ...
    description:
      ...
      - 'El regreso a Cangas de Onís se realiza por el **Alto del Torno**, un puerto de montaña muy entretenido que combina una carretera revirada con excelentes vistas del interior asturiano, poniendo el broche final a una jornada que recorre algunos de los paisajes más representativos de la costa oriental de Asturias y la Sierra del Sueve.'
    km: 119
  ...
  - day: 2
    ...
    description:
      - 'La segunda jornada abandona Cangas de Onís en dirección al **Desfiladero de los Beyos**, una de las carreteras más espectaculares del norte peninsular. Encajonada entre paredes verticales y siguiendo el curso del río Sella, la ruta asciende después hasta el **Puerto del Pontón**, desde donde se alcanza **Riaño**, cuyas vistas sobre el embalse y las montañas que lo rodean convierten la localidad en una parada imprescindible.'
  ...
  - day: 3
    ...
    description:
      - 'La última jornada comienza dejando atrás Fuente Dé para atravesar **Mogrovejo**, uno de los pueblos más pintorescos de Cantabria, antes de regresar a **Potes** y adentrarse en el impresionante **Desfiladero de La Hermida**. Encajada entre enormes paredes de roca y siguiendo el curso del río Deva, esta carretera ofrece uno de los recorridos más espectaculares del norte de España.'
      ...
      - 'Desde allí, la jornada pone rumbo a **Santillana del Mar**, considerada una de las villas medievales mejor conservadas de España. Sus calles empedradas y su arquitectura tradicional ofrecen el escenario perfecto para poner el broche final al día de ruta.'
    km: 117
